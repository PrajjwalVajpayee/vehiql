...
const AddCarForm = () => {
  ...
  const { register,
    ...
    useEffect(() => {
      console.log("addCarResult:", addCarResult); // Debugging log
      if (addCarResult?.success) {
        toast.success("Successfully added car.");
      } else if (addCarResult?.message) {
        toast.error(addCarResult.message);
      }
            ...
            <CardContent>
              ...
              >
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                  ...
                  <div className='space-y-2'>
                    <Label htmlFor='seats'>No of Seats {" "}
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        {carStatuses.map((type) => {
                          return (
                            <SelectItem key={type} value={type}>{type.charAt(0) + type.slice(1).toLocaleLowerCase()}</SelectItem>
                          )
                        })}
                ...
                <div>
                  <Label htmlFor='images'
                    className={`mb-2 ${imageError ? 'text-red-500' : ''}`}
                  >Images{" "}
...
>
                ...
                >{addCarLoading ?(<>
                <Loader className='mr-2 h-4 w-4 animate-spin' />Adding Car...
                                </>):("Add Car")}</Button>
              </form>
            </CardContent>
